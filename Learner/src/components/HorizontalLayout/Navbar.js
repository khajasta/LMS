            ...
            >
              <ul className="navbar-nav">
                ...
                <li className="nav-item dropdown">
                  ...
                  >
                    <i className="mdi mdi-book-education-outline"></i>{props.t("My Courses")}
                  </Link>
                  <div
                ...
                <li className="nav-item dropdown">
                  ...
                  >
                    <i className="mdi mdi-book-education-outline"></i>{props.t("My Certificates")}
                  </Link>
                  {/* <div
                ...
                <li className="nav-item dropdown">
                  ...
                  >
                    <i className="mdi mdi-file-document-multiple-outline"></i>{props.t("My Notes")}
                  </Link>
                  {/* <div
                    className={classname("dropdown-menu dropdown-menu-left", { show: email })}
                  >
